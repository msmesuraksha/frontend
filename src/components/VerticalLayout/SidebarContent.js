...
const SidebarContent = props => {
  ...
  return (
    <React.Fragment>
      {adminRole == "L3" && <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/Reopen-Requests">
                ...
                {/* <span className="badge rounded-pill text-bg-success float-end" key="t-new">New</span> */}
                {props.t("Reopen Request's")}
              </Link>
            </li>
            <li>
              <Link to="/status-opinion">
                {/*  <i className="bx bxs-dashboard"></i> */}
                <i className='bx bx-stats'></i>
                {/* <span className="badge rounded-pill text-bg-success float-end" key="t-new">New</span> */}
                {props.t("Status / Opinion")}
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/request-deactivate" >
                ...
                {/* <span className="badge rounded-pill text-bg-success float-end" key="t-new">New</span> */}
                {props.t("Request For Deactivation")}
              </Link>
            </li>
            {/*           <li>
              <Link to="/close-ticket">
                
                <i className='fa fa-times'></i>
                
                {props.t("Close Ticket")}
              </Link>
            </li> */}
      ...
      {adminRole == "L1" && <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            <li className="menu-title">{props.t("Menu")} </li>
            <li>
