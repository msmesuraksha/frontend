...
export const AllDocumentNeed = props => {
    ...
    const viewModel = (value) => {
        ...
        // });
        navigate('/LatestTranaction-View-Details', { state: { selected: value.cell.row.original.allDocumentNeed } });
    ...
    const latestTransactiondata = useSelector(selectAllDocumentNeedMap)
